...
public class GooglePay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new CustomDialog.Builder(GooglePay.this)
        ...
        if (animate && isAnimate) {
            ...
            editor.putBoolean("animate13", false);
            editor.apply();
        }
    ...
    public void verifyNumber(View view) {
        ...
        editor.apply();
        String number = "+" + countryCode.getFullNumber() + editText.getText().toString();
        HashMap<String, Object> hashMap = new HashMap<>();
        hashMap.put("isConsultant", true);
        hashMap.put("payOut", "GooglePay");
        hashMap.put("googlePayNumber", number);
