...
public class PaymentOption2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_option2);

        dialog = new CustomDialog.Builder(PaymentOption2.this)
        ...
        comingSoon = findViewById(R.id.comingSoon2);
        back = findViewById(R.id.backBtn11);
        paypal = findViewById(R.id.paypal2);

        SharedPreferences sharedPreferences = getSharedPreferences("Userdata", Context.MODE_PRIVATE);
        boolean animate = sharedPreferences.getBoolean("animate15", true);
        ...
        if (animate && isAnimate) {
            ...
            paypal.animate().alpha(1).translationX(0).setDuration(500).setStartDelay(400).start();
            comingSoon.animate().alpha(1).translationX(0).setDuration(500).setStartDelay(600).start();
            SharedPreferences.Editor editor = sharedPreferences.edit();
            editor.putBoolean("animate15", false);
            editor.apply();
        }
